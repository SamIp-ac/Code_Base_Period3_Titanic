...
history = classifier.fit(X, y, batch_size=5, validation_split=0.1, epochs=100, verbose=1, shuffle=True)
...
# Predicted
predicted0 = classifier.predict_classes(X0, batch_size=5)
Ans0 = pd.DataFrame()
Ans0['PassengerId'] = df['PassengerId']
Ans0['Survived'] = predicted0

Ans0.to_csv('Ans_titanic00027.csv', index=False)
